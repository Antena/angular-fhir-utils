...
/**
 * @ngdoc filter
 * @name angular-fhir-utils.patient.filter:fhirPatientFullName
 * @kind function
 *
 * @description
 ...
 * @example
 ...
 <div ng-controller="ExampleController">
 	<p>Patient: <strong>{{ patient | fhirPatientFullName }}</strong></p>
 </div>
 </file>
 <file name="demo.js">

 angular.module('patient-full-name-example', ['angular-fhir-utils.patient'])
